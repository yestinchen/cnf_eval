...
public class CNFAlgorithm implements ICNFEvaluator {
    ...
    public CNFAlgorithm(InvertedList<AttrValueKey> postingList, Map<Integer, int[]> counterMap) {
...
//                    System.exit(-1);
    ...
    public static CNFAlgorithm fromFile(String file) throws FileNotFoundException {
        ...
        return new CNFAlgorithm(invertedList, counterMap);
    }
}
